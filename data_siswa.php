...
if ($search) {
    $where_clause = " AND (nama LIKE '%$search%' 
                           OR nis LIKE '%$search%' 
...
$query = "SELECT * FROM siswa WHERE 1=1 $where_clause ORDER BY nama,nis,kelas,username";
...
<body>
    ...
    <div class="main-content">
        <div class="container">
            ...
            <!-- Form Pencarian & Tombol Cetak -->
            <div style="text-align: right; margin-bottom: 15px;">
                <form method="GET" action="" style="display: inline-block; margin-right: 10px;">
                    <input type="text" name="search" placeholder="Cari data siswa..." value="<?php echo htmlspecialchars($search); ?>" style="padding: 8px; border-radius: 6px; border: 1px solid #ccc; width: 250px;">
                    <button type="submit" class="print-btn" style="background: #005a9e;">🔍 Cari</button>
                    <?php if ($search): ?>
                        <a href="data_siswa.php" class="print-btn" style="background: #6c757d; text-decoration: none;">🗙 Reset</a>
                    <?php endif; ?>
                </form>
            ...
            <div id="print-area">
                <div style="text-align: center; margin-bottom: 15px;">
                    ...
                    <h2>Data Siswa - Pengaduan Digital</h2>
                    <hr>
                </div>
